...
import 'package:lessionlab/data/network/file_services.dart';
import 'package:lessionlab/data/network/firebase/auth_services.dart';
import 'package:lessionlab/utils/utils.dart';
...
class SignupController extends GetxController {
  ...
  Future<void> createAccount() async {
    ...
    if(!loading.value){
      ...
      try {
        setLoading(true);
        await FirebaseAuthService.createAccount(pictureUrl: await FileServices.uploadFile(filePath: profilePicture.value, uploadPath: 'profilePicture/${
